...
namespace Antiguera.WebApi.Controllers.Api
{
    ...
    public class JogoController : ApiController
    {
        ...
        /// <returns></returns>
        // GET api/antiguera/admin/jogo/ListarTodosJogos
        [HttpGet]
        [Route("ListarTodosJogos")]
        ...
        [HttpPost]
        [Route("InserirJogo")]
        public HttpResponseMessage InserirJogo([FromBody] JogoDTO jogoDto)
        {
            string action = this.ActionContext.ActionDescriptor.ActionName;
            _logger.Info(action + " - Iniciado");
            try
        ...
        [HttpPut]
        [Route("AtualizarJogo")]
        public HttpResponseMessage AtualizarJogo([FromBody] JogoDTO jogoDto)
        {
            string action = this.ActionContext.ActionDescriptor.ActionName;
            _logger.Info(action + " - Iniciado");
            try
        ...
        [HttpDelete]
        [Route("ExcluirJogo")]
        public HttpResponseMessage ExcluirJogo([FromBody] JogoDTO jogoDto)
        {
            string action = this.ActionContext.ActionDescriptor.ActionName;
            _logger.Info(action + " - Iniciado");
            try
